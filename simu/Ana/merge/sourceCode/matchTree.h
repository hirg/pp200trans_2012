...
long    g_geantProc_start_L[100];
long    g_geantMedium_start_L[100];
long    g_generatorProc_start_L[100];
long    g_key_start_L[100];
long    g_pid_parent_L[100];
long    g_gid_parent_L[100];
long    g_key_parent_L[100];
...
long    g_geantProc_start_A[100];
long    g_geantMedium_start_A[100];
long    g_generatorProc_start_A[100];
long    g_key_start_A[100];
long    g_pid_parent_A[100];
long    g_gid_parent_A[100];
long    g_key_parent_A[100];
...
long    g_geantProc_start_K[100];
long    g_geantMedium_start_K[100];
long    g_generatorProc_start_K[100];
long    g_key_start_K[100];
long    g_pid_parent_K[100];
long    g_gid_parent_K[100];
long    g_key_parent_K[100];
...
double  a_crp_L[100];
long    a_pid_parent_L[100];
long    a_gid_parent_L[100];
long    a_key_parent_L[100];
...
double  a_crp_A[100];
long    a_pid_parent_A[100];
long    a_gid_parent_A[100];
long    a_key_parent_A[100];
...
double  a_crp_K[100];
long    a_pid_parent_K[100];
long    a_gid_parent_K[100];
long    a_key_parent_K[100];
...
void BuildTree_Out( TTree *T )
{
    ...
    T->Branch("g_idSubproc", &g_idSubproc, "g_idSubproc/I");
    T->Branch("g_impactPar", &g_impactPar, "g_impactPar/D");
    ...
    T->Branch("g_geantProc_start_L", g_geantProc_start_L, "g_geantProc_start_L[g_nL]/I");
    T->Branch("g_geantMedium_start_L", g_geantMedium_start_L, "g_geantMedium_start_L[g_nL]/I");
    T->Branch("g_generatorProc_start_L", g_generatorProc_start_L, "g_generatorProc_start_L[g_nL]/I");
    T->Branch("g_key_start_L", g_key_start_L, "g_key_start_L[g_nL]/I");
    ...
    T->Branch("g_geantProc_start_A", g_geantProc_start_A, "g_geantProc_start_A[g_nA]/I");
    T->Branch("g_geantMedium_start_A", g_geantMedium_start_A, "g_geantMedium_start_A[g_nA]/I");
    T->Branch("g_generatorProc_start_A", g_generatorProc_start_A, "g_generatorProc_start_A[g_nA]/I");
    T->Branch("g_key_start_A", g_key_start_A, "g_key_start_A[g_nA]/I");
    ...
    T->Branch("g_geantProc_start_K", g_geantProc_start_K, "g_geantProc_start_K[g_nK]/I");
    T->Branch("g_geantMedium_start_K", g_geantMedium_start_K, "g_geantMedium_start_K[g_nK]/I");
    T->Branch("g_generatorProc_start_K", g_generatorProc_start_K, "g_generatorProc_start_K[g_nK]/I");
    T->Branch("g_key_start_K", g_key_start_K, "g_key_start_K[g_nK]/I");
