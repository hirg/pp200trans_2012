			...
			for iJ in xrange(0,2):
				...
				for iPT in xrange(0,6):
					...
					for i in xrange(0,5):
                        ...
                        pass
                        lg.Draw('same')
                        cn='Pic_base/h_%s_%s_%s_J%d_PT%d.eps'%(Type_List[iT],It_List[j],Par_List[iPar],iJ,iPT)
                        c.SaveAs(cn)
                        cn='Pic_base/h_%s_%s_%s_J%d_PT%d.png'%(Type_List[iT],It_List[j],Par_List[iPar],iJ,iPT)
                        c.SaveAs(cn)
